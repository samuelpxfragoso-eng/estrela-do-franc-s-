        ...
        <div id="oásis" className="grid lg:grid-cols-2 gap-24 items-center mb-0">
          ...
          >
            ...
            <p className="font-sans text-lg text-gray-500 leading-relaxed">
              Descubra um ambiente pensado para o seu descanso e diversão. Seja na tranquilidade da nossa piscina ou na convivência das áreas comuns, cada espaço foi desenhado para proporcionar o melhor da Praia do Francês.
            </p>
